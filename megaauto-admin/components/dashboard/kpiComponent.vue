  ...
  >
    <div>
      <div class="flex">
        ...
        <h3 class="text-sm font-semibold leading-tight flex-1 mb-2">
          {{ kpiTitle }}
        </h3>
      </div>
      <div class="relative overflow-hidden transition-all duration-500 w-36">
        <div>
          <h4
