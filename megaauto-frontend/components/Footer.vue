      ...
      >
        <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
          <a href="/" class="flex justify-center lg:justify-start">
            <h1 class="font-extrabold text-2xl text-primary hover:text-black">
              Mega Auto Auctions
            </h1>
          </a>
          <p
            class="py-5 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left"
          >
          ...
          <a
            href="/register"
            class="py-2.5 px-5 h-9 block w-fit bg-primary rounded-full shadow-sm text-xs text-white mx-auto transition-all duration-500 hover:bg-black lg:mx-0"
          >
            Register Now!
          </a>
        </div>
        ...
        <div class="lg:mx-auto text-left">
          <h4 class="text-lg text-gray-900 font-medium mb-7">Main</h4>
        ...
        <!--End Col-->
        <div class="lg:mx-auto text-left">
          <h4 class="text-lg text-gray-900 font-medium mb-7">Locations</h4>
          <ul class="text-sm transition-all duration-500">
            <li class="mb-6">
              <a href="javascript:;" class="text-gray-600 hover:text-gray-900"
                >USA</a
      ...
      <div class="py-7 border-t border-gray-200">
        ...
        >
          <span class="text-sm text-gray-500"
            >©<a href="#">MX Auto Auctions</a> 2024, All rights
            reserved.</span
          >
          <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0">
            <a
              href="javascript:;"
              class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-primary"
            >
              <svg
